...
export const theme = {
  ...
  extend: {
    backgroundImage: {
      ...
      "card-content": `radial-gradient(var(--circle-size) circle at var(--mouse-x) var(--mouse-y), rgb(var(--primary-bg) / 0.003), transparent), linear-gradient(rgb(var(--accent-bg) / 0.8), rgb(var(--accent-bg) / 0.8))`,
