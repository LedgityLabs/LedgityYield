...
export const theme = {
  ...
  extend: {
    backgroundImage: {
      ...
      "card-border": `radial-gradient(300px circle at var(--mouse-x) var(--mouse-y), rgb(var(--primary-bg) / 0.8), transparent), linear-gradient(rgb(var(--input) / 0.8), rgb(var(--input) / 0.8))`,
      "card-border-default": `
        radial-gradient(300px circle at 50% 100%, rgb(var(--primary-bg) / 0.5), transparent), radial-gradient(300px circle at var(--mouse-x) var(--mouse-y), rgb(var(--primary-bg) / 0.8), transparent), linear-gradient(rgb(var(--input) / 0.8), rgb(var(--input) / 0.8))`,
