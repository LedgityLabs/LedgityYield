...
export namespace LocalhostSubgraphTypes {
  ...
  export type ActivityAction = "WITHDRAW" | "DEPOSIT";

  export type ActivityStatus = "SUCCESS" | "CANCELLED" | "QUEUED";
  ...
  export type QuerySdk = {
    ...
    /** null **/
    ldystaking: InContextSdkMethod<Query["ldystaking"], QueryldystakingArgs, MeshContext>;
    /** null **/
    ldystakings: InContextSdkMethod<Query["ldystakings"], QueryldystakingsArgs, MeshContext>;
    /** null **/
    totalStakedUpdate: InContextSdkMethod<
      Query["totalStakedUpdate"],
      QuerytotalStakedUpdateArgs,
      MeshContext
    >;
    /** null **/
    totalStakedUpdates: InContextSdkMethod<
      Query["totalStakedUpdates"],
      QuerytotalStakedUpdatesArgs,
      MeshContext
    >;
    /** Access to subgraph metadata **/
  ...
  export type SubscriptionSdk = {
    ...
    rewardsMint: InContextSdkMethod<
      ...
      SubscriptionrewardsMintArgs,
      MeshContext
    >;
    /** null **/
    rewardsMints: InContextSdkMethod<
      Subscription["rewardsMints"],
      SubscriptionrewardsMintsArgs,
      MeshContext
    >;
    /** null **/
    ...
    ldystakings: InContextSdkMethod<
      ...
      SubscriptionldystakingsArgs,
      MeshContext
    >;
    /** null **/
    totalStakedUpdate: InContextSdkMethod<
      Subscription["totalStakedUpdate"],
      SubscriptiontotalStakedUpdateArgs,
      MeshContext
    >;
    /** null **/
    totalStakedUpdates: InContextSdkMethod<
      Subscription["totalStakedUpdates"],
      SubscriptiontotalStakedUpdatesArgs,
      MeshContext
    >;
    /** Access to subgraph metadata **/
