// Generated by @wagmi/cli@1.3.0 on 7/30/2023 at 5:12:43 PM
import {
  useContractRead,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link iTransfersListenerABI}__ and `functionName` set to `"onLTokenTransfers"`.
 */
export function useITransfersListenerOnLTokenTransfers<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof iTransfersListenerABI, 'onLTokenTransfers'>['request']['abi'],
        'onLTokenTransfers',
        TMode
      > & { functionName?: 'onLTokenTransfers' }
    : UseContractWriteConfig<typeof iTransfersListenerABI, 'onLTokenTransfers', TMode> & {
        abi?: never
        functionName?: 'onLTokenTransfers'
      } = {} as any,
) {
  return useContractWrite<typeof iTransfersListenerABI, 'onLTokenTransfers', TMode>({
    abi: iTransfersListenerABI,
    functionName: 'onLTokenTransfers',
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link iTransfersListenerABI}__ and `functionName` set to `"onLTokenTransfers"`.
 */
export function usePrepareITransfersListenerOnLTokenTransfers(
  config: Omit<
    UsePrepareContractWriteConfig<typeof iTransfersListenerABI, 'onLTokenTransfers'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'onLTokenTransfers',
    ...config,
  } as UsePrepareContractWriteConfig<typeof iTransfersListenerABI, 'onLTokenTransfers'>)
}
