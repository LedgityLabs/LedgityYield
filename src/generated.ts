// Generated by @wagmi/cli@1.3.0 on 7/3/2023 at 3:36:18 PM
import {
  useContractRead,
...
/**
 * Wraps **{@link useContractWrite}** with `abi` set to **{@link ltyStakingABI}** and `functionName` set to
 * `"setStaleLockDuration"`.
 */
export function useLtyStakingSetStaleLockDuration<
  TMode extends WriteContractMode = undefined,
  TChainId extends number = keyof typeof ltyStakingAddress,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof ltyStakingABI, 'setStaleLockDuration'>['request']['abi'],
        'setStaleLockDuration',
        TMode
      > & { address?: Address; chainId?: TChainId; functionName?: 'setStaleLockDuration' }
    : UseContractWriteConfig<typeof ltyStakingABI, 'setStaleLockDuration', TMode> & {
        abi?: never
        address?: never
        chainId?: TChainId
        functionName?: 'setStaleLockDuration'
      } = {} as any,
) {
  return useContractWrite<typeof ltyStakingABI, 'setStaleLockDuration', TMode>({
    abi: ltyStakingABI,
    address: ltyStakingAddress[31337],
    functionName: 'setStaleLockDuration',
    ...config,
...
/**
 * Wraps **{@link usePrepareContractWrite}** with `abi` set to **{@link ltyStakingABI}** and `functionName`
 * set to `"setStaleLockDuration"`.
 */
export function usePrepareLtyStakingSetStaleLockDuration(
  config: Omit<
    UsePrepareContractWriteConfig<typeof ltyStakingABI, 'setStaleLockDuration'>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof ltyStakingAddress } = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'setStaleLockDuration',
    ...config,
  } as UsePrepareContractWriteConfig<typeof ltyStakingABI, 'setStaleLockDuration'>)
}
