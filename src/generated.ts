// Generated by @wagmi/cli@1.3.0 on 8/22/2023 at 12:06:30 PM
import {
  useNetwork,
  useContractRead,
...
export const oldLTokenABI = [
  ...
  },
  {
    ...
    inputs: [
      { name: 'id', internalType: 'int256', type: 'int256', indexed: true },
      { name: 'account', internalType: 'address', type: 'address', indexed: true },
      { name: 'action', internalType: 'enum OldLToken.Action', type: 'uint8', indexed: true },
      { name: 'amount', internalType: 'uint256', type: 'uint256', indexed: false },
      { name: 'amountAfterFees', internalType: 'uint256', type: 'uint256', indexed: false },
      { name: 'newStatus', internalType: 'enum OldLToken.Status', type: 'uint8', indexed: false },
    ],
    name: 'ActivityEvent',
  },
  {
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__.
 */
export function useOldLTokenRead<
  TFunctionName extends string,
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof oldLTokenABI, TFunctionName, TSelectData>,
    'abi'
  > = {} as any,
) {
  return useContractRead({ abi: oldLTokenABI, ...config } as UseContractReadConfig<
    typeof oldLTokenABI,
    TFunctionName,
    TSelectData
  >)
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"allowance"`.
 */
export function useOldLTokenAllowance<
  TFunctionName extends 'allowance',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
  ...
  return useContractRead({
    ...
    functionName: 'allowance',
    ...config,
  } as UseContractReadConfig<typeof oldLTokenABI, TFunctionName, TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"balanceOf"`.
 */
export function useOldLTokenBalanceOf<
  TFunctionName extends 'balanceOf',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"decimals"`.
 */
export function useOldLTokenDecimals<
  TFunctionName extends 'decimals',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"depositFor"`.
 */
export function useOldLTokenDepositFor<
  TFunctionName extends 'depositFor',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"feesRateUD7x3"`.
 */
export function useOldLTokenFeesRateUd7x3<
  TFunctionName extends 'feesRateUD7x3',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"frozenRequests"`.
 */
export function useOldLTokenFrozenRequests<
  TFunctionName extends 'frozenRequests',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"fund"`.
 */
export function useOldLTokenFund<
  TFunctionName extends 'fund',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"getAPR"`.
 */
export function useOldLTokenGetApr<
  TFunctionName extends 'getAPR',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"getExpectedRetained"`.
 */
export function useOldLTokenGetExpectedRetained<
  TFunctionName extends 'getExpectedRetained',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"getWithdrawnAmountAndFees"`.
 */
export function useOldLTokenGetWithdrawnAmountAndFees<
  TFunctionName extends 'getWithdrawnAmountAndFees',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"globalBlacklist"`.
 */
export function useOldLTokenGlobalBlacklist<
  TFunctionName extends 'globalBlacklist',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"globalOwner"`.
 */
export function useOldLTokenGlobalOwner<
  TFunctionName extends 'globalOwner',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"globalPause"`.
 */
export function useOldLTokenGlobalPause<
  TFunctionName extends 'globalPause',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"invested"`.
 */
export function useOldLTokenInvested<
  TFunctionName extends 'invested',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"ldyStaking"`.
 */
export function useOldLTokenLdyStaking<
  TFunctionName extends 'ldyStaking',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"name"`.
 */
export function useOldLTokenName<
  TFunctionName extends 'name',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"owner"`.
 */
export function useOldLTokenOwner<
  TFunctionName extends 'owner',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"paused"`.
 */
export function useOldLTokenPaused<
  TFunctionName extends 'paused',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"proxiableUUID"`.
 */
export function useOldLTokenProxiableUuid<
  TFunctionName extends 'proxiableUUID',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"realBalanceOf"`.
 */
export function useOldLTokenRealBalanceOf<
  TFunctionName extends 'realBalanceOf',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"realTotalSupply"`.
 */
export function useOldLTokenRealTotalSupply<
  TFunctionName extends 'realTotalSupply',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function useOldLTokenRenounceOwnership<
  TFunctionName extends 'renounceOwnership',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"retentionRateUD7x3"`.
 */
export function useOldLTokenRetentionRateUd7x3<
  TFunctionName extends 'retentionRateUD7x3',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"rewardsRedirectsFromTo"`.
 */
export function useOldLTokenRewardsRedirectsFromTo<
  TFunctionName extends 'rewardsRedirectsFromTo',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"rewardsRedirectsToFrom"`.
 */
export function useOldLTokenRewardsRedirectsToFrom<
  TFunctionName extends 'rewardsRedirectsToFrom',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"symbol"`.
 */
export function useOldLTokenSymbol<
  TFunctionName extends 'symbol',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"totalQueued"`.
 */
export function useOldLTokenTotalQueued<
  TFunctionName extends 'totalQueued',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"totalSupply"`.
 */
export function useOldLTokenTotalSupply<
  TFunctionName extends 'totalSupply',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"transferOwnership"`.
 */
export function useOldLTokenTransferOwnership<
  TFunctionName extends 'transferOwnership',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"transfersListeners"`.
 */
export function useOldLTokenTransfersListeners<
  TFunctionName extends 'transfersListeners',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"unclaimedFees"`.
 */
export function useOldLTokenUnclaimedFees<
  TFunctionName extends 'unclaimedFees',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"underlying"`.
 */
export function useOldLTokenUnderlying<
  TFunctionName extends 'underlying',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"unmintedRewardsOf"`.
 */
export function useOldLTokenUnmintedRewardsOf<
  TFunctionName extends 'unmintedRewardsOf',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"usableUnderlyings"`.
 */
export function useOldLTokenUsableUnderlyings<
  TFunctionName extends 'usableUnderlyings',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"withdrawTo"`.
 */
export function useOldLTokenWithdrawTo<
  TFunctionName extends 'withdrawTo',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"withdrawalQueue"`.
 */
export function useOldLTokenWithdrawalQueue<
  TFunctionName extends 'withdrawalQueue',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"withdrawalQueueCursor"`.
 */
export function useOldLTokenWithdrawalQueueCursor<
  TFunctionName extends 'withdrawalQueueCursor',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"withdrawer"`.
 */
export function useOldLTokenWithdrawer<
  TFunctionName extends 'withdrawer',
  TSelectData = ReadContractResult<typeof oldLTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__.
 */
export function useOldLTokenWrite<
  TFunctionName extends string,
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, string>['request']['abi'],
        TFunctionName,
        TMode
      >
    : UseContractWriteConfig<typeof oldLTokenABI, TFunctionName, TMode> & {
        abi?: never
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, TFunctionName, TMode>({
    abi: oldLTokenABI,
    ...config,
  } as any)
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"approve"`.
 */
export function useOldLTokenApprove<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'approve'>['request']['abi'],
        'approve',
        TMode
      > & { functionName?: 'approve' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'approve', TMode> & {
        abi?: never
        functionName?: 'approve'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'approve', TMode>({
    abi: oldLTokenABI,
    functionName: 'approve',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"cancelWithdrawalRequest"`.
 */
export function useOldLTokenCancelWithdrawalRequest<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        TMode
      > & { functionName?: 'cancelWithdrawalRequest' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'cancelWithdrawalRequest', TMode> & {
        abi?: never
        functionName?: 'cancelWithdrawalRequest'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'cancelWithdrawalRequest', TMode>({
    abi: oldLTokenABI,
    functionName: 'cancelWithdrawalRequest',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"claimFees"`.
 */
export function useOldLTokenClaimFees<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'claimFees'>['request']['abi'],
        'claimFees',
        TMode
      > & { functionName?: 'claimFees' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'claimFees', TMode> & {
        abi?: never
        functionName?: 'claimFees'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'claimFees', TMode>({
    abi: oldLTokenABI,
    functionName: 'claimFees',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"decreaseAllowance"`.
 */
export function useOldLTokenDecreaseAllowance<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'decreaseAllowance'>['request']['abi'],
        'decreaseAllowance',
        TMode
      > & { functionName?: 'decreaseAllowance' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'decreaseAllowance', TMode> & {
        abi?: never
        functionName?: 'decreaseAllowance'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'decreaseAllowance', TMode>({
    abi: oldLTokenABI,
    functionName: 'decreaseAllowance',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"deposit"`.
 */
export function useOldLTokenDeposit<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'deposit'>['request']['abi'],
        'deposit',
        TMode
      > & { functionName?: 'deposit' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'deposit', TMode> & {
        abi?: never
        functionName?: 'deposit'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'deposit', TMode>({
    abi: oldLTokenABI,
    functionName: 'deposit',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"increaseAllowance"`.
 */
export function useOldLTokenIncreaseAllowance<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'increaseAllowance'>['request']['abi'],
        'increaseAllowance',
        TMode
      > & { functionName?: 'increaseAllowance' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'increaseAllowance', TMode> & {
        abi?: never
        functionName?: 'increaseAllowance'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'increaseAllowance', TMode>({
    abi: oldLTokenABI,
    functionName: 'increaseAllowance',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"initialize"`.
 */
export function useOldLTokenInitialize<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'initialize'>['request']['abi'],
        'initialize',
        TMode
      > & { functionName?: 'initialize' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'initialize', TMode> & {
        abi?: never
        functionName?: 'initialize'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'initialize', TMode>({
    abi: oldLTokenABI,
    functionName: 'initialize',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"instantWithdrawal"`.
 */
export function useOldLTokenInstantWithdrawal<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'instantWithdrawal'>['request']['abi'],
        'instantWithdrawal',
        TMode
      > & { functionName?: 'instantWithdrawal' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'instantWithdrawal', TMode> & {
        abi?: never
        functionName?: 'instantWithdrawal'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'instantWithdrawal', TMode>({
    abi: oldLTokenABI,
    functionName: 'instantWithdrawal',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"listenToTransfers"`.
 */
export function useOldLTokenListenToTransfers<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'listenToTransfers'>['request']['abi'],
        'listenToTransfers',
        TMode
      > & { functionName?: 'listenToTransfers' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'listenToTransfers', TMode> & {
        abi?: never
        functionName?: 'listenToTransfers'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'listenToTransfers', TMode>({
    abi: oldLTokenABI,
    functionName: 'listenToTransfers',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"processBigQueuedRequest"`.
 */
export function useOldLTokenProcessBigQueuedRequest<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<
          typeof oldLTokenABI,
        ...
        TMode
      > & { functionName?: 'processBigQueuedRequest' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'processBigQueuedRequest', TMode> & {
        abi?: never
        functionName?: 'processBigQueuedRequest'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'processBigQueuedRequest', TMode>({
    abi: oldLTokenABI,
    functionName: 'processBigQueuedRequest',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"processQueuedRequests"`.
 */
export function useOldLTokenProcessQueuedRequests<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'processQueuedRequests'>['request']['abi'],
        'processQueuedRequests',
        TMode
      > & { functionName?: 'processQueuedRequests' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'processQueuedRequests', TMode> & {
        abi?: never
        functionName?: 'processQueuedRequests'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'processQueuedRequests', TMode>({
    abi: oldLTokenABI,
    functionName: 'processQueuedRequests',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"recoverERC20"`.
 */
export function useOldLTokenRecoverErc20<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'recoverERC20'>['request']['abi'],
        'recoverERC20',
        TMode
      > & { functionName?: 'recoverERC20' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'recoverERC20', TMode> & {
        abi?: never
        functionName?: 'recoverERC20'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'recoverERC20', TMode>({
    abi: oldLTokenABI,
    functionName: 'recoverERC20',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"recoverUnderlying"`.
 */
export function useOldLTokenRecoverUnderlying<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'recoverUnderlying'>['request']['abi'],
        'recoverUnderlying',
        TMode
      > & { functionName?: 'recoverUnderlying' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'recoverUnderlying', TMode> & {
        abi?: never
        functionName?: 'recoverUnderlying'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'recoverUnderlying', TMode>({
    abi: oldLTokenABI,
    functionName: 'recoverUnderlying',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"repatriate"`.
 */
export function useOldLTokenRepatriate<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'repatriate'>['request']['abi'],
        'repatriate',
        TMode
      > & { functionName?: 'repatriate' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'repatriate', TMode> & {
        abi?: never
        functionName?: 'repatriate'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'repatriate', TMode>({
    abi: oldLTokenABI,
    functionName: 'repatriate',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"requestWithdrawal"`.
 */
export function useOldLTokenRequestWithdrawal<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'requestWithdrawal'>['request']['abi'],
        'requestWithdrawal',
        TMode
      > & { functionName?: 'requestWithdrawal' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'requestWithdrawal', TMode> & {
        abi?: never
        functionName?: 'requestWithdrawal'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'requestWithdrawal', TMode>({
    abi: oldLTokenABI,
    functionName: 'requestWithdrawal',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"setAPR"`.
 */
export function useOldLTokenSetApr<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'setAPR'>['request']['abi'],
        'setAPR',
        TMode
      > & { functionName?: 'setAPR' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'setAPR', TMode> & {
        abi?: never
        functionName?: 'setAPR'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'setAPR', TMode>({
    abi: oldLTokenABI,
    functionName: 'setAPR',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"setFeesRate"`.
 */
export function useOldLTokenSetFeesRate<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'setFeesRate'>['request']['abi'],
        'setFeesRate',
        TMode
      > & { functionName?: 'setFeesRate' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'setFeesRate', TMode> & {
        abi?: never
        functionName?: 'setFeesRate'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'setFeesRate', TMode>({
    abi: oldLTokenABI,
    functionName: 'setFeesRate',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"setFund"`.
 */
export function useOldLTokenSetFund<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'setFund'>['request']['abi'],
        'setFund',
        TMode
      > & { functionName?: 'setFund' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'setFund', TMode> & {
        abi?: never
        functionName?: 'setFund'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'setFund', TMode>({
    abi: oldLTokenABI,
    functionName: 'setFund',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"setLDYStaking"`.
 */
export function useOldLTokenSetLdyStaking<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'setLDYStaking'>['request']['abi'],
        'setLDYStaking',
        TMode
      > & { functionName?: 'setLDYStaking' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'setLDYStaking', TMode> & {
        abi?: never
        functionName?: 'setLDYStaking'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'setLDYStaking', TMode>({
    abi: oldLTokenABI,
    functionName: 'setLDYStaking',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"setRetentionRate"`.
 */
export function useOldLTokenSetRetentionRate<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'setRetentionRate'>['request']['abi'],
        'setRetentionRate',
        TMode
      > & { functionName?: 'setRetentionRate' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'setRetentionRate', TMode> & {
        abi?: never
        functionName?: 'setRetentionRate'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'setRetentionRate', TMode>({
    abi: oldLTokenABI,
    functionName: 'setRetentionRate',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"setWithdrawer"`.
 */
export function useOldLTokenSetWithdrawer<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'setWithdrawer'>['request']['abi'],
        'setWithdrawer',
        TMode
      > & { functionName?: 'setWithdrawer' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'setWithdrawer', TMode> & {
        abi?: never
        functionName?: 'setWithdrawer'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'setWithdrawer', TMode>({
    abi: oldLTokenABI,
    functionName: 'setWithdrawer',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"startRewardsRedirection"`.
 */
export function useOldLTokenStartRewardsRedirection<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<
          typeof oldLTokenABI,
        ...
        TMode
      > & { functionName?: 'startRewardsRedirection' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'startRewardsRedirection', TMode> & {
        abi?: never
        functionName?: 'startRewardsRedirection'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'startRewardsRedirection', TMode>({
    abi: oldLTokenABI,
    functionName: 'startRewardsRedirection',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"stopRewardsRedirection"`.
 */
export function useOldLTokenStopRewardsRedirection<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'stopRewardsRedirection'>['request']['abi'],
        'stopRewardsRedirection',
        TMode
      > & { functionName?: 'stopRewardsRedirection' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'stopRewardsRedirection', TMode> & {
        abi?: never
        functionName?: 'stopRewardsRedirection'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'stopRewardsRedirection', TMode>({
    abi: oldLTokenABI,
    functionName: 'stopRewardsRedirection',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"transfer"`.
 */
export function useOldLTokenTransfer<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'transfer'>['request']['abi'],
        'transfer',
        TMode
      > & { functionName?: 'transfer' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'transfer', TMode> & {
        abi?: never
        functionName?: 'transfer'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'transfer', TMode>({
    abi: oldLTokenABI,
    functionName: 'transfer',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"transferFrom"`.
 */
export function useOldLTokenTransferFrom<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'transferFrom'>['request']['abi'],
        'transferFrom',
        TMode
      > & { functionName?: 'transferFrom' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'transferFrom', TMode> & {
        abi?: never
        functionName?: 'transferFrom'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'transferFrom', TMode>({
    abi: oldLTokenABI,
    functionName: 'transferFrom',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"unlistenToTransfers"`.
 */
export function useOldLTokenUnlistenToTransfers<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'unlistenToTransfers'>['request']['abi'],
        'unlistenToTransfers',
        TMode
      > & { functionName?: 'unlistenToTransfers' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'unlistenToTransfers', TMode> & {
        abi?: never
        functionName?: 'unlistenToTransfers'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'unlistenToTransfers', TMode>({
    abi: oldLTokenABI,
    functionName: 'unlistenToTransfers',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"upgradeTo"`.
 */
export function useOldLTokenUpgradeTo<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'upgradeTo'>['request']['abi'],
        'upgradeTo',
        TMode
      > & { functionName?: 'upgradeTo' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'upgradeTo', TMode> & {
        abi?: never
        functionName?: 'upgradeTo'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'upgradeTo', TMode>({
    abi: oldLTokenABI,
    functionName: 'upgradeTo',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"upgradeToAndCall"`.
 */
export function useOldLTokenUpgradeToAndCall<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof oldLTokenABI, 'upgradeToAndCall'>['request']['abi'],
        'upgradeToAndCall',
        TMode
      > & { functionName?: 'upgradeToAndCall' }
    : UseContractWriteConfig<typeof oldLTokenABI, 'upgradeToAndCall', TMode> & {
        abi?: never
        functionName?: 'upgradeToAndCall'
      } = {} as any,
) {
  return useContractWrite<typeof oldLTokenABI, 'upgradeToAndCall', TMode>({
    abi: oldLTokenABI,
    functionName: 'upgradeToAndCall',
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__.
 */
export function usePrepareOldLTokenWrite<TFunctionName extends string>(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, TFunctionName>,
    'abi'
  > = {} as any,
) {
  return usePrepareContractWrite({ abi: oldLTokenABI, ...config } as UsePrepareContractWriteConfig<
    typeof oldLTokenABI,
    TFunctionName
  >)
}
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"approve"`.
 */
export function usePrepareOldLTokenApprove(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'approve'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'approve',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'approve'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"cancelWithdrawalRequest"`.
 */
export function usePrepareOldLTokenCancelWithdrawalRequest(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'cancelWithdrawalRequest'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'cancelWithdrawalRequest',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'cancelWithdrawalRequest'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"claimFees"`.
 */
export function usePrepareOldLTokenClaimFees(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'claimFees'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'claimFees',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'claimFees'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"decreaseAllowance"`.
 */
export function usePrepareOldLTokenDecreaseAllowance(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'decreaseAllowance'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'decreaseAllowance',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'decreaseAllowance'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"deposit"`.
 */
export function usePrepareOldLTokenDeposit(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'deposit'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'deposit',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'deposit'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"increaseAllowance"`.
 */
export function usePrepareOldLTokenIncreaseAllowance(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'increaseAllowance'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'increaseAllowance',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'increaseAllowance'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"initialize"`.
 */
export function usePrepareOldLTokenInitialize(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'initialize'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'initialize',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'initialize'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"instantWithdrawal"`.
 */
export function usePrepareOldLTokenInstantWithdrawal(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'instantWithdrawal'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'instantWithdrawal',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'instantWithdrawal'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"listenToTransfers"`.
 */
export function usePrepareOldLTokenListenToTransfers(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'listenToTransfers'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'listenToTransfers',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'listenToTransfers'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"processBigQueuedRequest"`.
 */
export function usePrepareOldLTokenProcessBigQueuedRequest(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'processBigQueuedRequest'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'processBigQueuedRequest',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'processBigQueuedRequest'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"processQueuedRequests"`.
 */
export function usePrepareOldLTokenProcessQueuedRequests(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'processQueuedRequests'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'processQueuedRequests',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'processQueuedRequests'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"recoverERC20"`.
 */
export function usePrepareOldLTokenRecoverErc20(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'recoverERC20'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'recoverERC20',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'recoverERC20'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"recoverUnderlying"`.
 */
export function usePrepareOldLTokenRecoverUnderlying(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'recoverUnderlying'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'recoverUnderlying',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'recoverUnderlying'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"repatriate"`.
 */
export function usePrepareOldLTokenRepatriate(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'repatriate'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'repatriate',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'repatriate'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"requestWithdrawal"`.
 */
export function usePrepareOldLTokenRequestWithdrawal(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'requestWithdrawal'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'requestWithdrawal',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'requestWithdrawal'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"setAPR"`.
 */
export function usePrepareOldLTokenSetApr(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'setAPR'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'setAPR',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'setAPR'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"setFeesRate"`.
 */
export function usePrepareOldLTokenSetFeesRate(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'setFeesRate'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'setFeesRate',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'setFeesRate'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"setFund"`.
 */
export function usePrepareOldLTokenSetFund(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'setFund'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'setFund',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'setFund'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"setLDYStaking"`.
 */
export function usePrepareOldLTokenSetLdyStaking(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'setLDYStaking'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'setLDYStaking',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'setLDYStaking'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"setRetentionRate"`.
 */
export function usePrepareOldLTokenSetRetentionRate(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'setRetentionRate'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'setRetentionRate',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'setRetentionRate'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"setWithdrawer"`.
 */
export function usePrepareOldLTokenSetWithdrawer(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'setWithdrawer'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'setWithdrawer',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'setWithdrawer'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"startRewardsRedirection"`.
 */
export function usePrepareOldLTokenStartRewardsRedirection(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'startRewardsRedirection'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'startRewardsRedirection',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'startRewardsRedirection'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"stopRewardsRedirection"`.
 */
export function usePrepareOldLTokenStopRewardsRedirection(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'stopRewardsRedirection'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'stopRewardsRedirection',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'stopRewardsRedirection'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"transfer"`.
 */
export function usePrepareOldLTokenTransfer(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'transfer'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'transfer',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'transfer'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"transferFrom"`.
 */
export function usePrepareOldLTokenTransferFrom(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'transferFrom'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'transferFrom',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'transferFrom'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"unlistenToTransfers"`.
 */
export function usePrepareOldLTokenUnlistenToTransfers(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'unlistenToTransfers'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'unlistenToTransfers',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'unlistenToTransfers'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"upgradeTo"`.
 */
export function usePrepareOldLTokenUpgradeTo(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'upgradeTo'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'upgradeTo',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'upgradeTo'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link oldLTokenABI}__ and `functionName` set to `"upgradeToAndCall"`.
 */
export function usePrepareOldLTokenUpgradeToAndCall(
  config: Omit<
    UsePrepareContractWriteConfig<typeof oldLTokenABI, 'upgradeToAndCall'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'upgradeToAndCall',
    ...config,
  } as UsePrepareContractWriteConfig<typeof oldLTokenABI, 'upgradeToAndCall'>)
}
...
/**
 * Wraps __{@link getContract}__ with `abi` set to __{@link oldLTokenABI}__.
 */
export function getOldLToken(config: Omit<GetContractArgs, 'abi'>) {
  return getContract({ abi: oldLTokenABI, ...config })
}

/**
 * Wraps __{@link readContract}__ with `abi` set to __{@link oldLTokenABI}__.
 */
export function readOldLToken<
  TAbi extends readonly unknown[] = typeof oldLTokenABI,
  TFunctionName extends string = string,
>(config: Omit<ReadContractConfig<TAbi, TFunctionName>, 'abi'>) {
  return readContract({ abi: oldLTokenABI, ...config } as unknown as ReadContractConfig<
    TAbi,
    TFunctionName
  >)
}
...
/**
 * Wraps __{@link writeContract}__ with `abi` set to __{@link oldLTokenABI}__.
 */
export function writeOldLToken<TFunctionName extends string>(
  config:
    | Omit<WriteContractPreparedArgs<typeof oldLTokenABI, TFunctionName>, 'abi'>
    | Omit<WriteContractUnpreparedArgs<typeof oldLTokenABI, TFunctionName>, 'abi'>,
) {
  return writeContract({ abi: oldLTokenABI, ...config } as unknown as WriteContractArgs<
    typeof oldLTokenABI,
    TFunctionName
  >)
}
...
/**
 * Wraps __{@link prepareWriteContract}__ with `abi` set to __{@link oldLTokenABI}__.
 */
export function prepareWriteOldLToken<
  TAbi extends readonly unknown[] = typeof oldLTokenABI,
  TFunctionName extends string = string,
>(config: Omit<PrepareWriteContractConfig<TAbi, TFunctionName>, 'abi'>) {
  return prepareWriteContract({
