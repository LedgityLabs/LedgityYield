...
export const ReplyIcon: FC<SVGProps> = ({ className }) => (
...
export const LikeIcon: FC<SVGProps> = ({ className }) => (
  <svg viewBox="0 0 24 24" aria-hidden="true" className={className}>
    <g>
...
export const RetweetIcon: FC<SVGProps> = ({ className }) => (
  <svg viewBox="0 0 24 24" aria-hidden="true" className={className}>
    <g>
...
export const QuoteIcon: FC<SVGProps> = ({ className }) => (
  <svg viewBox="0 0 24 24" aria-hidden="true" className={className}>
    <g>
...
export const ReachIcon: FC<SVGProps> = ({ className }) => (
  <svg viewBox="0 0 24 24" aria-hidden="true" className={className}>
    <g>
