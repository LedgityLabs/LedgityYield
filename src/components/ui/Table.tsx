...
export const Table: FC<React.HTMLAttributes<HTMLTableElement>> = ({
  className,
  ...props
}) => (
  <table
...
export const TableHeader: FC<React.HTMLAttributes<HTMLTableSectionElement>> = ({
  ...props
}) => <thead {...props} />;

export const TableBody: FC<React.HTMLAttributes<HTMLTableSectionElement>> = ({
  ...props
}) => <tbody {...props} />;
...
export const TableHead: FC<React.ThHTMLAttributes<HTMLTableCellElement>> = ({
  className,
  ...props
}) => (
  <th
