  ...
  return (
    <section className="relative flex flex-col items-center justify-center">
      ...
      <div className="flex max-w-[calc(24rem*3+3rem*3+2*2rem)] flex-wrap justify-center gap-12 px-8 pt-8">
        ...
        >
          <h3 className="bg-gradient-radial absolute top-6 z-10 rounded-2xl from-bg/50 to-transparent p-1 text-center font-heading text-2xl font-bold text-fg/80 backdrop-blur-md">
            Long term stability
          </h3>
          <div
          ...
          ></div>
          <p className="bg-gradient-radial absolute bottom-7 left-7 right-7 -mt-4 rounded-2xl from-bg/50 to-transparent text-center text-[17px] font-medium text-fg/70 backdrop-blur-md">
