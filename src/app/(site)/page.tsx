...
const Page: NextPage = () => {
  return (
    <>
      ...
      <div className="relative top-[100vh] z-10 overflow-hidden border-t-2 border-t-primary/50 bg-[url('/assets/textures/other-glow.webp')] bg-cover bg-[left_30%_top_30%] pb-[100vh] pt-12 shadow-2xl shadow-primary/50 backdrop-blur-3xl [border-radius:53%_47%_0%_0%/1%_1%_100%_100%] md:bg-top md:[border-radius:53%_47%_0%_0%/3%_3%_100%_100%]">
        <HomeFeatures />
        <HomeHowItWorks />
        <HomePartners />
      </div>
