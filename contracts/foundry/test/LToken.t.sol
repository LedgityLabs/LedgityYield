...
contract TestedContract is LToken {
  ...
  function public_withdrawalQueueLength()
    public
    view
    returns (uint256)
  {
  ...
  function public_withdrawalQueueCursor()
    public
    view
    returns (uint256)
  {
  ...
  function public_frozenRequestsLength()
    public
    view
    returns (uint256)
  {
...
contract Tests is Test, ModifiersExpectations {
  ...
  function test_onlyFund_1(address account) public {
    console.log(
      "Should revert calls made from non-fund wallet and success fund ones"
    );
  ...
  function testFuzz_setRetentionRate_2(
    uint32 _retentionRateUD7x3
  ) public {
    console.log(
      "Should revert if trying to set retention rate higher than 10%"
    );
  ...
  function testFuzz_setRetentionRate_3(
    uint32 _retentionRateUD7x3
  ) public {
  ...
  function testFuzz_setLDYStaking_1(
    address account,
    address _contract
  ) public {
    console.log("Should revert if not called by owner");
  ...
  function testFuzz_setWithdrawer_1(
    address account,
  ...
  function testFuzz_setWithdrawer_2() public {
    console.log(
      "Should revert if trying to set the zero address as withdrawer"
    );
  ...
  function testFuzz_setWithdrawer_3(
    address payable _withdrawer
  ) public {
  ...
  function testFuzz_setFund_2() public {
    console.log(
      "Should revert if trying to set the zero address as fund"
    );
  ...
  function testFuzz_realBalance_1(
    uint16 aprUD7x3,
    address account,
    uint256 amount
  ) public {
  ...
  function testFuzz_recoverUnderlying_3(
    ...
    depositedAmount = uint216(
      bound(depositedAmount, 2, 100_000_000_000_000 * 10 ** decimals)
    );
  ...
  function test__distributeRewards_1(
    uint16 aprUD7x3,
    address account,
    uint256 amount
  ) public {
  ...
  function test__distributeRewards_2(
    uint16 aprUD7x3,
    uint256 amount
  ) public {
  ...
  function test__distributeRewards_3(
    uint16 aprUD7x3,
    address account,
    uint256 amount
  ) public {
  ...
  function testFuzz__beforeTokenTransfer_3(
    ...
    if (from != address(0)) {
      assertEq(
        tested.public_accountsInfos(from).period.timestamp,
        block.timestamp
      );
    }
    if (to != address(0)) {
      assertEq(
        tested.public_accountsInfos(to).period.timestamp,
        block.timestamp
      );
    }
  }
  ...
  function testFuzz_getExpectedRetained_1(
    ...
    uint256 expectedRetainedSUD = SUD.fromAmount(
      expectedRetained,
      decimals
    );
    uint256 retentionRateSUD = (expectedRetainedSUD *
      SUD.fromInt(100, decimals)) / totalSupplySUD;
    uint256 expectedRetentionRateUD7x3 = SUD.toRate(
      retentionRateSUD,
      decimals
    );

    // Compute difference between expected retention rate and actual retention rate
    uint256 difference = expectedRetentionRateUD7x3 >
      retentionRateUD7x3
  ...
  function testFuzz_getExpectedRetained_2(
    ...
    uint256 retentionRateSUD = SUD.fromRate(
      retentionRateUD7x3,
      decimals
    );
    uint256 expectedRetainedSUD = SUD.fromAmount(
    ...
    uint256 totalSupplySUD = (expectedRetainedSUD *
      SUD.fromInt(100, decimals)) / retentionRateSUD;
    uint256 expectedTotalSupply = SUD.toAmount(
      totalSupplySUD,
      decimals
    );
  ...
  function testFuzz_transferExceedingToFund_1(
    ...
    uint256 oldFundBalance = underlyingToken.balanceOf(
      address(fundWallet)
    );
    ...
    assertEq(
      underlyingToken.balanceOf(address(fundWallet)),
      oldFundBalance
    );
    assertEq(
      underlyingToken.balanceOf(address(tested)),
  ...
  // =============================
  // === withdrawTo() function ===
  function testFuzz_withdrawTo_1(
    address account,
    uint256 amount
  ) public {
  ...
  // =============================
  // === depositFor() function ===
  function testFuzz_depositFor_1(
    address account,
    uint256 amount
  ) public {
    console.log("Should inconditionally revert");
  ...
  function testFuzz_deposit_4(
    ...
    uint256 oldContractBalance = underlyingToken.balanceOf(
      address(tested)
    );
  ...
  function testFuzz_deposit_6(
    ...
    assertEq(
      tested.usableUnderlyings(),
      oldUsableUnderlying + depositedAmount
    );
  }
  ...
  function testFuzz_deposit_7(
    ...
    assertTrue(
      tested.usableUnderlyings() <= tested.getExpectedRetained()
    );
  }
  ...
  function testFuzz_getWithdrawnAmountAndFees_3(
    ...
    // Get withdraw amount and fees
    (, uint256 fees) = tested.getWithdrawnAmountAndFees(
      account,
      amount
    );

    // Obtain applied feesRateUD7x3 from input amount and fees amount
    uint256 feesRateSUD = (SUD.fromAmount(fees, decimals) *
      SUD.fromInt(100, decimals)) / SUD.fromAmount(amount, decimals);
  ...
  function testFuzz_instantWithdrawal_1(
    address account,
    uint256 amount
  ) public {
    console.log("Should revert if contract is paused");
  ...
  function testFuzz_instantWithdrawal_2(
    address account,
    uint256 amount
  ) public {
    console.log("Should revert if account is blacklisted");
  ...
  function testFuzz_instantWithdrawal_5(
    ...
    tested.tool_rawSetUsableUnderlyings(
      tested.usableUnderlyings() - 1
    );
  ...
  function testFuzz_instantWithdrawal_6(
    ...
    assertEq(
      underlyingToken.balanceOf(account2),
      depositedAmount - fees
    );
  }
  ...
  function testFuzz_instantWithdrawal_9(
    ...
    assertEq(
      tested.usableUnderlyings(),
      oldUsableUnderlying - withdrawnAmount
    );
  }
  ...
  function testFuzz_instantWithdrawal_10(
    ...
    assertEq(
      tested.realTotalSupply(),
      oldRealTotalSupply - depositedAmount
    );
  }
  ...
  function testFuzz_processQueuedRequests_4(
    ...
    accountBase = uint160(
      bound(accountBase, 1, type(uint160).max - numberOfRequests)
    );
    ...
    for (uint8 id = 0; id < numberOfRequests; id++) {
      ...
      if (id % emptyInterval == 0) {
        ...
        (address _requestAccount, uint256 _requestAmount) = tested
          .withdrawalQueue(id);
    ...
    assertEq(
      tested.totalQueued(),
      requestAmount * numberOfNonEmptyRequests
    );
  ...
  function testFuzz_processQueuedRequests_5(
    ...
    uint256 blacklistInterval = bound(
      randomBlacklistSeed,
      1,
      numberOfRequests
    );
    ...
    assertEq(
      blacklistedRequestsIdsLength,
      tested.public_frozenRequestsLength()
    );

    // Assert that the cumulated frozen amount remains queued
    assertEq(
      tested.totalQueued(),
      blacklistedRequestsIdsLength * requestAmount
    );
  }
  ...
  function testFuzz_processQueuedRequests_6(
    ...
    assertEq(
      tested.public_withdrawalQueueLength(),
      oldQueueLength + 1
    );
  ...
  function testFuzz_processQueuedRequests_8(
    ...
    numberOfNotCoveredRequests = uint8(
      bound(numberOfNotCoveredRequests, 1, numberOfRequests)
    );
    ...
    uint256 newUsableUnderlyings = tested.usableUnderlyings() -
      burnAmount;
    ...
    // Assert that states haven't changed
    uint256 expectedStillQueued = numberOfNotCoveredRequests *
      requestAmount;
  ...
  function testFuzz_processQueuedRequests_9(
    ...
    for (uint8 i = 0; i < numberOfRequests; i++) {
      ...
      uint256 newUnderlyingBalance = underlyingToken.balanceOf(
        account
      );
      ...
      assertEq(
        ...
        oldUnderlyingBalances[i] + withdrawnAmount
      );
    }
  }
  ...
  function testFuzz_processQueuedRequests_12(
    ...
    assertEq(
      tested.usableUnderlyings(),
      oldUsableUnderlyings - expectedDecrease
    );
  }
  ...
  function test_processQueuedRequests_15() public {
    ...
    assertGt(
      tested.public_withdrawalQueueLength(),
      tested.public_withdrawalQueueCursor()
    );
  }

  // ====================================
  // === processBigQueuedRequest() function ===
  function testFuzz_processBigQueuedRequest_1(
    address account,
    uint256 requestId
  ) public {
  ...
  function testFuzz_processBigQueuedRequest_2(
    uint256 requestId
  ) public {
    console.log("Should revert if contract is paused");
    globalPause.pause();
  ...
  function testFuzz_processBigQueuedRequest_6(
    ...
    if (burnAmount <= fundBalance) {
      ...
      tested.tool_rawSetUsableUnderlyings(
        tested.usableUnderlyings() - remainingToBurn
      );
    }
  ...
  function testFuzz_processBigQueuedRequest_9(
    ...
    // Assert that unclaimed fees has increased by the expected amount
    (, uint256 expectedFees) = tested.getWithdrawnAmountAndFees(
      account,
      amount
    );
  ...
  function testFuzz_processBigQueuedRequest_11(
    ...
    (
      address deletedRequestAccount,
      uint256 deletedRequestAmount
    ) = tested.withdrawalQueue(0);
  ...
  function testFuzz_requestWithdrawal_1(
    address account,
    uint256 amount
  ) public {
    console.log("Should revert if contract is paused");
  ...
  function testFuzz_requestWithdrawal_2(
    address account,
    uint256 amount
  ) public {
    console.log("Should revert if account is blacklisted");
  ...
  function testFuzz_requestWithdrawal_8(
    ...
    (address requestAccount, uint256 requestAmount) = tested
      .withdrawalQueue(0);
  ...
  function testFuzz_requestWithdrawal_9(
    ...
    (address requestAccount, uint256 requestAmount) = tested
      .withdrawalQueue(tested.withdrawalQueueCursor());
  ...
  function testFuzz_cancelWithdrawalRequest_1(
    address account,
    uint256 requestId
  ) public {
    console.log("Should revert if contract is paused");
  ...
  function testFuzz_cancelWithdrawalRequest_2(
    address account,
    uint256 requestId
  ) public {
    console.log("Should revert if account is blacklisted");
  ...
  // =============================
  // === repatriate() function ===
  function testFuzz_repatriate_1(
    address account,
    uint256 requestId
  ) public {
    console.log("Should revert if not called by fund wallet");
  ...
  function testFuzz_repatriate_4(
    ...
    if (
      fundedAmount + tested.usableUnderlyings() >
      tested.getExpectedRetained()
    ) {
      // Expect revert
  ...
  function testFuzz_repatriate_5(
    ...
    uint256 oldFundWalletUnderlyingBalance = underlyingToken
      .balanceOf(fundWallet);
    uint256 oldLTokenUnderlyingBalance = underlyingToken.balanceOf(
      address(tested)
    );
  ...
  function testFuzz_repatriate_6(
    ...
    assertEq(
      tested.usableUnderlyings(),
      oldUsableUnderlyings + fundedAmount
    );
  }
  ...
  function testFuzz_claimFees_2() public {
    console.log(
      "Should revert if there is no unclaimed fees to claim"
    );
  ...
  function testFuzz_claimFees_4(
    ...
    uint256 oldOwnerUnderlyingBalance = underlyingToken.balanceOf(
      tested.owner()
    );
    uint256 oldLTokenUnderlyingBalance = underlyingToken.balanceOf(
      address(tested)
  ...
  function testFuzz_claimFees_6(
    ...
    assertEq(
      tested.usableUnderlyings(),
      oldUsableUnderlyings - unclaimedFees
    );
  }
}
