...
contract TestedContract is InvestUpgradeable {
  ...
  function set_distributeRewards_ResetInvestmentPeriod(
    bool value
  ) public {
  ...
  function _distributeRewards(
    ...
    if (_distributeRewards_ResetInvestmentPeriod) {
      _beforeInvestmentChange(
        account,
        _distributeRewards_Autocompound
      );
    }
...
contract Tests is Test, ModifiersExpectations {
  ...
  function testFuzz_startRewardsRedirection_1(
    address from,
    address to
  ) public {
  ...
  function testFuzz_startRewardsRedirection_2(
    address from,
    address to
  ) public {
  ...
  function testFuzz_startRewardsRedirection_3(
    address from,
    address to
  ) public {
  ...
  function testFuzz_startRewardsRedirection_4(
    ...
    console.log(
      "Should revert if trying to redirect while a redirection is already active"
    );
  ...
  function testFuzz_startRewardsRedirection_7(
    address account
  ) public {
  ...
  function testFuzz_startRewardsRedirection_8(
    ...
    console.log(
      "Should revert if caller is neither the owner nor the from account"
    );
  ...
  function testFuzz_startRewardsRedirection_9(
    uint16 aprUD7x3,
    address from,
    address to
  ) public {
  ...
  function testFuzz_startRewardsRedirection_10(
    uint16 aprUD7x3,
    address from,
    address to
  ) public {
  ...
  function testFuzz_startRewardsRedirection_11(
    ...
    console.log(
      "Should reset from and to accounts investment periods"
    );
    // Set first random APR
    tested.setAPR(aprUD7x3);
  ...
  function testFuzz_startRewardsRedirection_12(
    uint16 aprUD7x3,
    address from,
    address to
  ) public {
    console.log(
      "Should set to at from index in rewardsRedirectsFromTo"
    );
    // Set first random APR
    tested.setAPR(aprUD7x3);
  ...
  function testFuzz_startRewardsRedirection_13(
    ...
    console.log(
      "Should push from into at to index in rewardsRedirectsToFrom"
    );
    // Set first random APR
    tested.setAPR(aprUD7x3);
  ...
  function testFuzz_stopRewardsRedirection_1(
    address from,
    address to
  ) public {
    console.log("Should revert if contract is paused ");
  ...
  function testFuzz_stopRewardsRedirection_2(
    address from,
    address to
  ) public {
    console.log("Should revert if from account is blacklisted");
  ...
  function testFuzz_stopRewardsRedirection_3(
    address from,
    address to
  ) public {
    console.log("Should revert if to account is blacklisted");
  ...
  function testFuzz_stopRewardsRedirection_7(
    uint16 aprUD7x3,
    address from,
    address to
  ) public {
  ...
  function testFuzz_stopRewardsRedirection_8(
    uint16 aprUD7x3,
    address from,
    address to
  ) public {
  ...
  function testFuzz_stopRewardsRedirection_9(
    address from,
    address to
  ) public {
    console.log(
      "Should revert there were no redirect for given from and to accounts"
    );
  ...
  function testFuzz_stopRewardsRedirection_11(
    uint16 aprUD7x3,
    address from,
    address to
  ) public {
  ...
  function testFuzz_stopRewardsRedirection_12(
    uint16 aprUD7x3,
    address from,
    address to
  ) public {
    console.log(
      "Should properly remove from address from index to in rewardsRedirectsToFrom"
    );
    // Set first random APR
    tested.setAPR(aprUD7x3);
  ...
  function testFuzz__calculatePeriodRewards_2(
    ...
    uint256 investedAmountSUD = SUD.fromAmount(
      investedAmount,
      decimals
    );

    // - Compute growth of investedAmount after rewards
    uint256 growthSUD = (rewardsSUD * SUD.fromInt(100, decimals)) /
      investedAmountSUD;

    // - Compute elapsed time in years
    uint256 elaspedTimeSUD = SUD.fromInt(
      endTimestamp - beginTimestamp,
      decimals
    );
    uint256 elapsedYearsSUD = (elaspedTimeSUD *
      SUD.fromInt(1, decimals)) / SUD.fromInt(365 days, decimals);

    // - Obtain applied APR from above values
    uint256 appliedAPRSUD = (growthSUD * SUD.fromInt(1, decimals)) /
      elapsedYearsSUD;
  ...
  function testFuzz__calculatePeriodRewards_3(
    ...
    endTimestamp = uint40(
      bound(endTimestamp, beginTimestamp + 10 days, type(uint40).max)
    );
  ...
  function testFuzz__calculatePeriodRewards_4(
    ...
    uint256 appliedElapsedYearSUD = (growthSUD *
      SUD.fromInt(1, decimals)) / aprSUD;
    uint256 appliedElapsedTimeSUD = (appliedElapsedYearSUD *
      SUD.fromInt(365 days, decimals)) / SUD.fromInt(1, decimals);
    uint256 appliedElapsedTime = SUD.toInt(
      appliedElapsedTimeSUD,
      decimals
    );
  ...
  function testFuzz__calculatePeriodRewards_6(
    ...
    // - Compute growth of investedAmount after rewards
    uint256 growthSUD = (elapsedYearsSUD * aprSUD) /
      SUD.fromInt(1, decimals);

    // - Obtain applied invested amount from above values
    uint256 appliedInvestedAmountSUD = (rewardsSUD *
      SUD.fromInt(100, decimals)) / growthSUD;
    uint256 appliedInvestedAmount = SUD.toAmount(
      appliedInvestedAmountSUD,
      decimals
    );
  ...
  function testFuzz__deepInvestmentOf_2(
    ...
    amount = bound(
      amount,
      0,
      100_000_000_000_000 * 10 ** investedToken.decimals()
    );
  ...
  function testFuzz__deepInvestmentOf_3(
    ...
    assertEq(
      tested.public_deepInvestmentOf(account1),
      amount + 1 + amount + 2
    );
    ...
    assertEq(
      tested.public_deepInvestmentOf(account2),
      amount + 2 + amount + 3
    );
  }
  ...
  // =============================
  // === _rewardsOf() function ===
  function testFuzz__rewardsOf_1(
    uint8 decimals,
    bool autocompound
  ) public {
  ...
  function testFuzz__rewardsOf_2(
    uint8 decimals,
    uint16 aprUD7x3,
    bool autocompound
  ) public {
    console.log(
      "Should return 0 when APR checkpoints but no investment"
    );
  ...
  function testFuzz__rewardsOf_3(
    ...
    investmentDuration = bound(
      investmentDuration,
      0,
      type(uint40).max - startTimestamp
    ); // prevent overflow
    ...
    assertEq(
      tested.public_rewardsOf(address(1234), autocompound),
      expectedRewards
    );
  }
  ...
  function testFuzz__rewardsOf_4(
    ...
    investmentDuration = uint40(
      bound(investmentDuration, 0, 365 days)
    );
    ...
    uint256 rewards = tested.public_rewardsOf(
      address(1234),
      autocompound
    );
  ...
  function testFuzz__rewardsOf_5(
    ...
    uint256 depositedAmount = investedAmount +
      1 +
      investedAmount +
      2 +
      investedAmount +
  ...
  function testFuzz__deepResetInvestmentPeriodOf_1(
    ...
    assertEq(
      tested.public_accountsInfos(account).period.timestamp,
      0
    );
  ...
  function testFuzz__deepResetInvestmentPeriodOf_2(
    ...
    assertEq(
      tested.public_accountsInfos(account1).period.timestamp,
      1
    );
    assertEq(
      tested.public_accountsInfos(account2).period.timestamp,
      1
    );
    assertEq(
      tested.public_accountsInfos(account3).period.timestamp,
      1
    );
    ...
    // Set new APR
    uint16 newAPRUD7x3 = aprUD7x3 < type(uint16).max
      ? aprUD7x3 + 1
      : aprUD7x3 - 1;
    tested.setAPR(newAPRUD7x3);
    ...
    assertEq(
      tested.public_accountsInfos(account1).period.ref.cursorIndex,
      2
    );
    ...
    assertEq(
      tested.public_accountsInfos(account2).period.ref.cursorIndex,
      1
    );
    ...
    assertEq(
      tested.public_accountsInfos(account3).period.ref.cursorIndex,
      1
    );
  }
  ...
  function test__beforeInvestmentChange_1(
    ...
    investmentDuration = uint40(
      bound(investmentDuration, 0, 100 * 365 days)
    );
  ...
  function test__beforeInvestmentChange_2(
    ...
    uint256 expectedRewards = tested.public_rewardsOf(
      address(1234),
      autocompound
    );
    ...
    if (isImplemented) {
      ...
      uint256 newVirtualBalance = tested
        .public_accountsInfos(address(1234))
        .virtualBalance;
    ...
    // If it isn't
      ...
      assertEq(
        newVirtualBalance,
        oldVirtualBalance + expectedRewards
      );
    }
  }
  ...
  function test__beforeInvestmentChange_3(
    ...
    uint256 account1Rewards = tested.public_rewardsOf(
      account1,
      autocompound
    );
    ...
    if (isImplemented) {
      assertEq(
        tested.stakeOf(account1),
        investedAmount + 1 + account1Rewards
      );
    }
    // Else assert that rewards have been accumulated in virtual balance
    else {
      assertEq(
        tested.public_accountsInfos(account1).virtualBalance,
        account1Rewards
      );
    }
  }
  ...
  function test__beforeInvestmentChange_4(
    ...
    console.log(
      "Should reset investment period timestamp of given account to now"
    );
    ...
    assertEq(
      tested.public_accountsInfos(address(1234)).period.timestamp,
      block.timestamp
    );
  }
