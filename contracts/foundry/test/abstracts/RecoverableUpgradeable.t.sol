...
contract Tests is Test, ModifiersExpectations {
  ...
  function test_recoverERC20_3() public {
    console.log(
      "Should revert if given address is not an ERC20 contract"
    );
  ...
  function test_recoverERC20_5() public {
    console.log(
      "Should revert if there is not enough token to recover"
    );
  ...
  function test_recoverERC20_6(
    ...
    assertEq(
      recoveredToken.balanceOf(address(this)),
      recoveredAmount
    );
  }
}
