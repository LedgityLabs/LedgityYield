import { getNamedType, getNullableType, GraphQLList, isListType, Kind, } from 'graphql';
import { defaultMergedResolver, } from '@graphql-tools/delegate';
import { appendObjectFields, relocatedError, removeObjectFields, } from '@graphql-tools/utils';
...
export default class HoistField {
    ...
    transformSchema(originalWrappingSchema, subschemaConfig) {
        ...
        let resolve;
        const hoistingToRootField = this.typeName === originalWrappingSchema.getQueryType()?.name ||
