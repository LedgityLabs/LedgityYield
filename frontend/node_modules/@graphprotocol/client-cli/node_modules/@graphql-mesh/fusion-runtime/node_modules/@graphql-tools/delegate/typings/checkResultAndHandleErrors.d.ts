...
export declare function checkResultAndHandleErrors<TContext extends Record<string, any>>(result: ExecutionResult<any, any> | undefined, delegationContext: DelegationContext<TContext>): any;
