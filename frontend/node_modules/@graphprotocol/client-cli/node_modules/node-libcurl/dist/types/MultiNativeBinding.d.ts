...
export declare class MultiNativeBinding {
     ...
     * Official libcurl documentation: [`curl_multi_setopt()`](http://curl.haxx.se/libcurl/c/curl_multi_setopt.html)
     */
    setOpt(option: 'PUSHFUNCTION', value: (parent: EasyNativeBinding, duplicatedHandle: EasyNativeBinding, pushFrameHeaders: Http2PushFrameHeaders) => CurlPush): CurlMultiCode;
    /**
     ...
     */
    onMessage(cb: ((error: Error, easyHandle: EasyNativeBinding, errorCode: CurlCode) => void) | null): this;
    /**
...
export {};
//# sourceMappingURL=MultiNativeBinding.d.ts.map