...
function createMergedTypeResolver(mergedTypeResolverOptions, mergedType) {
    ...
    if (argsFromKeys != null) {
        return function mergedBatchedTypeResolver(_originalResult, context, info, subschema, selectionSet, key, type = mergedType || (0, graphql_1.getNamedType)(info.returnType)) {
    ...
    if (args != null) {
        return function mergedTypeResolver(originalResult, context, info, subschema, selectionSet, _key, type = mergedType || (0, graphql_1.getNamedType)(info.returnType)) {
