...
exports.getValidationSettings = exports.validateInputEnumConsistency = exports.validateTypeConsistency = exports.validateInputFieldConsistency = exports.validateInputObjectConsistency = exports.validateFieldConsistency = void 0;
...
function validationMessage(message, settingNamespace, typeMergingOptions) {
    ...
    switch (settings.validationLevel ?? types_js_1.ValidationLevel.Warn) {
