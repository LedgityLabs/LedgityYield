import { getNamedType, getNullableType, isEnumType, isListType, isNonNullType, isScalarType, } from 'graphql';
...
export function getValidationSettings(settingNamespace, typeMergingOptions) {
    return {
