import { getNamedType, isAbstractType, isInputObjectType, isInterfaceType, isLeafType, isObjectType, isUnionType, Kind, print, } from 'graphql';
import { ValueOrPromise } from 'value-or-promise';
import { collectFields, isSome, parseSelectionSet, } from '@graphql-tools/utils';
        ...
        if (isObjectType(typeCandidates[typeName][0].type) ||
            ...
            if (mergeTypes === true ||
                ...
                for (const typeCandidate of typeCandidates[typeName]) {
                    ...
                    const resolver = mergedTypeConfig.resolve ?? createMergedTypeResolver(mergedTypeConfig, type);
                    if (resolver == null) {
                        continue;
                    }
