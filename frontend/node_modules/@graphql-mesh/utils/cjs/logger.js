...
class DefaultLogger {
    ...
    warn(...args) {
        ...
        const message = this.getLoggerMessage({ args });
        const fullMessage = `[${getTimestamp()}] WARN  ${this.prefix} ${(0, exports.warnColor)(message)}`;
        if (cross_helpers_1.process?.stderr?.write(fullMessage + '\n')) {
            return;
        }
