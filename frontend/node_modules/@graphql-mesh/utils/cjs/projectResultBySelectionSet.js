...
exports.projectResultBySelectionSet = projectResultBySelectionSet;
function projectResultBySelectionSet({ result, selectionSet, fragments = {}, }) {
        ...
        for (const selection of selectionSet.selections) {
            switch (selection.kind) {
                ...
                case 'FragmentSpread': {
                    ...
                    Object.assign(projectedResult, projectResultBySelectionSet({ result, selectionSet: fragment.selectionSet, fragments }));
                    break;
                }
                case 'InlineFragment': {
                    Object.assign(projectedResult, projectResultBySelectionSet({
                        result,
                        selectionSet: selection.selectionSet,
                        fragments,
                    }));
