...
export function prepareGatewayDocument(originalDocument, transformedSchema, returnType, infoSchema) {
    ...
    return visit(expandedDocument, visitWithTypeInfo(typeInfo, {
        [Kind.SELECTION_SET]: node => visitSelectionSet(node, fragmentReplacements, transformedSchema, typeInfo, possibleTypesMap, reversePossibleTypesMap, interfaceExtensionsMap, fieldNodesByType, fieldNodesByField, dynamicSelectionSetsByField, infoSchema, visitedSelections),
    }), 
        ...
        for (const selection of node.selections) {
            if (selection.kind === Kind.INLINE_FRAGMENT) {
                ...
                if (isAbstractType(parentType)) {
                    ...
                    const field = fieldMap[fieldName];
                    if (field) {
                        const unavailableFields = extractUnavailableFields(transformedSchema, field, selection, shouldAdd);
